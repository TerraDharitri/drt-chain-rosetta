			...
			Operations: []*types.Operation{
				{
					...
					Account:             addressToAccountIdentifier("drt1tn62hjp72rznp8vq0lplva5csav6rccpqqdungpxtqz0g2hcq6uqc2zmmy"),
				...
				},
				{
					...
					Account:             addressToAccountIdentifier("drt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq85hk5z"),
					Amount:              extension.valueToNativeAmount("10000000000000000"),
					Status:              &opStatusSuccess,
				},
				{
				...
				},
				{
					...
					Account:             addressToAccountIdentifier("drt1qqqqqqqqqqqqqpgqc4vdnqgc48ww26ljxqe2flgl86jewg0nq6uqwpa8cv"),
					Amount:              extension.valueToNativeAmount("10000000000000000"),
					Status:              &opStatusSuccess,
				},
			},
...
func TestTransactionsTransformer_TransformBlockTxsHavingDCDTIssue(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	...
	blocks, err := readTestBlocks("testdata/blocks_with_dcdt_issue.json")
	require.Nil(t, err)
		...
		Operations: []*types.Operation{
			{
				Type:                opTransfer,
				OperationIdentifier: indexToOperationIdentifier(0),
				Account:             addressToAccountIdentifier("drt1testnlersh4z0wsv8kjx39me4rmnvjkwu8dsaea7ukdvvc9z396qe2mapq"),
...
func TestTransactionsTransformer_ExtractOperationsFromEventDCDT(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	...
	t.Run("with custom currency (known)", func(t *testing.T) {
		...
		operations := transformer.extractOperationsFromEventDCDT(event)
	...
	t.Run("with native currency", func(t *testing.T) {
		event := &eventDCDT{
			identifier:      nativeAsDCDTIdentifier,
			senderAddress:   testscommon.TestAddressAlice,
			receiverAddress: testscommon.TestAddressBob,
			value:           "1234",
		}
...
func TestTransactionsTransformer_TransformBlockTxsHavingDCDTTransfer(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	networkProvider.MockCustomCurrencies = []resources.Currency{{Symbol: "ROSETTA-3a2edf"}}
	...
	blocks, err := readTestBlocks("testdata/blocks_with_dcdt_transfer.json")
	require.Nil(t, err)
	...
	expectedTransferTx := &types.Transaction{
		...
		Operations: []*types.Operation{
			...
			},
			{
				Type:                opCustomTransfer,
				OperationIdentifier: indexToOperationIdentifier(2),
				Account:             addressToAccountIdentifier("drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c"),
				Amount:              extension.valueToCustomAmount("50", "ROSETTA-3a2edf"),
				Status:              &opStatusSuccess,
			},
		},
...
func TestTransactionsTransformer_TransformBlockTxsHavingMultiDCDTTransfer(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	...
	blocks, err := readTestBlocks("testdata/blocks_with_multi_dcdt_transfer.json")
	require.Nil(t, err)
...
func TestTransactionsTransformer_TransformBlockTxsHavingDCDTMint(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	...
	blocks, err := readTestBlocks("testdata/blocks_with_dcdt_mint.json")
	require.Nil(t, err)
		...
		Operations: []*types.Operation{
			{
				Type:                opFee,
				OperationIdentifier: indexToOperationIdentifier(0),
				Account:             addressToAccountIdentifier("drt1r69gk66fmedhhcg24g2c5kn2f2a5k4kvpr6jfw67dn2lyydd8cfsncd6w8"),
...
func TestTransactionsTransformer_TransformBlockTxsHavingDCDTBurn(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	networkProvider.MockObservedActualShard = 1
	networkProvider.MockCustomCurrencies = []resources.Currency{{Symbol: "TEST-484fa1"}}
	...
	blocks, err := readTestBlocks("testdata/blocks_with_dcdt_burn.json")
	require.Nil(t, err)
...
func TestTransactionsTransformer_TransformBlockTxsHavingDCDTWipe(t *testing.T) {
	networkProvider := testscommon.NewNetworkProviderMock()
	networkProvider.MockObservedActualShard = 1
	networkProvider.MockCustomCurrencies = []resources.Currency{{Symbol: "TEST-484fa1"}}
	...
	blocks, err := readTestBlocks("testdata/blocks_with_dcdt_wipe.json")
	require.Nil(t, err)
		...
		Operations: []*types.Operation{
			{
				Type:                opFee,
				OperationIdentifier: indexToOperationIdentifier(0),
				Account:             addressToAccountIdentifier("drt1kdl46yctawygtwg2k462307dmz2v55c605737dp3zkxh04sct7asacg58j"),
	...
	// Block 1 (results of wipe DCDT, refund)
	txs, err = transformer.transformBlockTxs(blocks[1])
	require.Nil(t, err)
	require.Len(t, txs, 2)
