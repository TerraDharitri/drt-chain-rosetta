...
func TestConstructionService_ConstructionMetadata(t *testing.T) {
	...
	t.Run("with custom currency, with explicitly providing gas limit and price", func(t *testing.T) {
		...
		expectedMetadata := &constructionMetadata{
			...
			GasLimit:       500000,
			GasPrice:       1000000000,
			Data:           []byte("DCDTTransfer@544553542d616263646566@04d2"),
			ChainID:        "T",
			Version:        1,
		}
...
func TestConstructionService_ConstructionPayloads(t *testing.T) {
	...
	expectedTxJson := `{"nonce":42,"value":"1234","receiver":"drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c","sender":"drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf","gasPrice":1000000000,"gasLimit":57500,"data":"aGVsbG8=","chainID":"T","version":1}`
...
func TestConstructionService_ConstructionParse(t *testing.T) {
	...
	t.Run("native transfer", func(t *testing.T) {
		notSignedTx := `{"nonce":42,"value":"1234","receiver":"drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c","sender":"drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf","gasPrice":1100000000,"gasLimit":57500,"data":"aGVsbG8=","chainID":"T","version":1}`
	...
	t.Run("custom transfer", func(t *testing.T) {
		notSignedTx := `{"nonce":42,"value":"1234","receiver":"drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c","sender":"drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf","gasPrice":1100000000,"gasLimit":57500,"data":"RENEVFRyYW5zZmVyQDU0NDU1MzU0MmQ2MTYyNjM2NDY1NjZAMDRkMg==","chainID":"T","version":1}`
...
func TestConstructionService_ConstructionCombine(t *testing.T) {
	...
	signedTx := `{"nonce":42,"value":"1234","receiver":"drt1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruqlqde3c","sender":"drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf","gasPrice":1100000000,"gasLimit":57500,"data":"aGVsbG8=","signature":"aabb","chainID":"T","version":1}`
