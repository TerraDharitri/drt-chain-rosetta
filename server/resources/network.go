...
type NodeStatus struct {
	...
	ConnectedPeersCounts string `json:"drt_num_connected_peers_classification"`
	ObserverPublicKey    string `json:"drt_public_key_block_sign"`
	IsSyncing            int    `json:"drt_is_syncing"`
	CurrentEpoch         uint32 `json:"drt_epoch_number"`
	HighestNonce         uint64 `json:"drt_nonce"`
	HighestFinalNonce    uint64 `json:"drt_highest_final_nonce"`
}
