...
func TestBuildUrlGetAccount(t *testing.T) {
	...
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf?onFinalBlock=true", url)
}
...
func TestBuildUrlGetAccountNativeBalance(t *testing.T) {
	...
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf?blockNonce=7", url)

	url = buildUrlGetAccountNativeBalance(testscommon.TestAddressAlice, optionsAtBlockHash)
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf?blockHash=aabbccdd", url)

	url = buildUrlGetAccountNativeBalance(testscommon.TestAddressAlice, resources.AccountQueryOptions{})
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf", url)
}
...
func TestBuildUrlGetAccountFungibleTokenBalance(t *testing.T) {
	...
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/dcdt/ABC-abcdef?onFinalBlock=true", url)

	url = buildUrlGetAccountFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", optionsAtBlockNonce)
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/dcdt/ABC-abcdef?blockNonce=7", url)

	url = buildUrlGetAccountFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", optionsAtBlockHash)
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/dcdt/ABC-abcdef?blockHash=aabbccdd", url)

	url = buildUrlGetAccountFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", resources.AccountQueryOptions{})
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/dcdt/ABC-abcdef", url)
}
...
func TestBuildUrlGetAccountNonFungibleTokenBalance(t *testing.T) {
	...
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/nft/ABC-abcdef/nonce/10?onFinalBlock=true", url)

	url = buildUrlGetAccountNonFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", 10, optionsAtBlockNonce)
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/nft/ABC-abcdef/nonce/10?blockNonce=7", url)

	url = buildUrlGetAccountNonFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", 10, optionsAtBlockHash)
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/nft/ABC-abcdef/nonce/10?blockHash=aabbccdd", url)

	url = buildUrlGetAccountNonFungibleTokenBalance(testscommon.TestAddressAlice, "ABC-abcdef", 10, resources.AccountQueryOptions{})
	require.Equal(t, "/address/drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf/nft/ABC-abcdef/nonce/10", url)
}
