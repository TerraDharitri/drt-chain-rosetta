...
# https://github.com/TerraDharitri/drt-sdk-testwallets/blob/main/users/bob.pem.
...
CONFIGURATIONS = {
    "mainnet": Configuration(
        ...
        view_url="https://explorer.dharitri.org/transactions/{hash}",
    ),
    "devnet": Configuration(
        ...
        view_url="https://devnet-explorer.dharitri.org/transactions/{hash}",
    ...
    "testnet": Configuration(
        ...
        view_url="https://testnet-explorer.dharitri.org/transactions/{hash}",
        generate_relayed_v3=True
    ),
