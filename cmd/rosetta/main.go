...
import (
	...
	"github.com/TerraDharitri/drt-chain-rosetta/server/factory"
	"github.com/TerraDharitri/drt-chain-rosetta/version"
...
func main() {
	...
	app.Name = "DharitrI Rosetta CLI App"
	app.Version = version.RosettaMiddlewareVersion
	app.Usage = "This is the entry point for starting a new DharitrI Rosetta instance"
