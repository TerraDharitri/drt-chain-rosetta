...
`
	...
	cliFlagBlockchainName = cli.StringFlag{
		Name:  "blockchain",
		Usage: "Specifies the blockchain name (e.g. DharitrI).",
		Value: "DharitrI",
	}
	...
	cliFlagNativeCurrencySymbol = cli.StringFlag{
		...
		Usage: "Specifies the symbol of the native currency (must be REWA for mainnet, XREWA for testnet and devnet).",
		Value: "REWA",
	}
